...
import { createPost, deletePost, getAllComments, getAllPosts, incrementPostLike, postComment } from '@/config/action/postAction';
          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.scrollComponent}>
              ...
              <div className={styles.createPostContainer}>
                ...
                <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} className={styles.textAreaOfContent} name="" id="" placeholder={"what's on your mind?"}></textarea>
                    ...
                    <div key={post._id} className={styles.singleCard}>
                      ...
                      <div className={styles.singleCard_profileContainer}>
                        ...
                        <div>
                          ...
                          <p style={{ color: "grey", fontStyle: "italic" }}>@{post.userId.username}</p>
                      ...
                      <div className={styles.optionsContainer}>
                        <div onClick={async () => {
                          await dispatch(incrementPostLike(post._id));
                          dispatch(getAllPosts());
                        }}
...

          {
            ...
            <div onClick={() => dispatch(resetPostId())}
              ...
              <div onClick={(e) => e.stopPropagation()}
                ...
                {Array.isArray(postState.comments) && postState.comments.length === 0 && <h4>No comments yet on this Post</h4>}
                ...
                <div className={styles.postCommentContainer}>
                  <input type="text" value={commentText} onChange={(e) => setCommentText(e.target.value)} placeholder='Add your Comment' />
                  <div onClick={async () => {
                    console.log("comment btn clicked");
                    await dispatch(postComment({ post_id: postState.postId, body: commentText }))
                    console.log("Dispatching getAllComments for postId:", postState.postId);
